...
{
    public static WindowInsetsCompat dispatchApplyWindowInsets(final View view, WindowInsetsCompat windowInsetsCompat) {
        if (windowInsetsCompat instanceof WindowInsetsCompatApi21) {
            ...
            if (dispatchApplyWindowInsets != unwrap) {
                windowInsetsCompat = new WindowInsetsCompatApi21(dispatchApplyWindowInsets);
            }
        }
