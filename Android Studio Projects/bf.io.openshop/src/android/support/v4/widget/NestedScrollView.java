    ...
    public boolean onTouchEvent(final MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 2: {
                ...
                if (n4 < 0) {
                    this.mEdgeGlowTop.onPull(n2 / this.getHeight(), MotionEventCompat.getX(motionEvent, pointerIndex) / this.getWidth());
                    if (!this.mEdgeGlowBottom.isFinished()) {
                        this.mEdgeGlowBottom.onRelease();
                    }
                }
                else if (n4 > scrollRange) {
                    this.mEdgeGlowBottom.onPull(n2 / this.getHeight(), 1.0f - MotionEventCompat.getX(motionEvent, pointerIndex) / this.getWidth());
                    if (!this.mEdgeGlowTop.isFinished()) {
                        this.mEdgeGlowTop.onRelease();
                    }
                }
