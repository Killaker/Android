...
public class MenuBuilder implements SupportMenu
{
    ...
    private void setShortcutsVisibleInner(final boolean b) {
        ...
        if (!b || this.mResources.getConfiguration().keyboard == (mShortcutsVisible ? 1 : 0) || !this.mResources.getBoolean(R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent)) {
