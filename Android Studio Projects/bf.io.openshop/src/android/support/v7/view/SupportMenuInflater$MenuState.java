...
private class MenuState
{
    ...
    private <T> T newInstance(final String s, final Class<?>[] array, final Object[] array2) {
        try {
            final Constructor<?> constructor = SupportMenuInflater.access$100(SupportMenuInflater.this).getClassLoader().loadClass(s).getConstructor(array);
    ...
    private void setItem(final MenuItem menuItem) {
        ...
        if (this.itemListenerMethodName != null) {
            ...
            menuItem.setOnMenuItemClickListener((MenuItem$OnMenuItemClickListener)new InflatedOnMenuItemClickListener(SupportMenuInflater.access$400(SupportMenuInflater.this), this.itemListenerMethodName));
        }
        ...
        if (itemActionViewClassName != null) {
            MenuItemCompat.setActionView(menuItem, this.newInstance(this.itemActionViewClassName, SupportMenuInflater.access$500(), SupportMenuInflater.access$600(SupportMenuInflater.this)));
            b = true;
        }
    ...
    public void readGroup(final AttributeSet set) {
        final TypedArray obtainStyledAttributes = SupportMenuInflater.access$100(SupportMenuInflater.this).obtainStyledAttributes(set, R.styleable.MenuGroup);
    ...
    public void readItem(final AttributeSet set) {
        final TypedArray obtainStyledAttributes = SupportMenuInflater.access$100(SupportMenuInflater.this).obtainStyledAttributes(set, R.styleable.MenuItem);
        ...
        if (b && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
            this.itemActionProvider = this.newInstance(this.itemActionProviderClassName, SupportMenuInflater.access$200(), SupportMenuInflater.access$300(SupportMenuInflater.this));
        }
        else {
            if (b) {
