...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener
{
    ...
    private ViewHolder findSwipedView(final MotionEvent motionEvent) {
        ...
        if (this.mActivePointerId != -1) {
            ...
            final float n = MotionEventCompat.getX(motionEvent, pointerIndex) - this.mInitialTouchX;
            final float n2 = MotionEventCompat.getY(motionEvent, pointerIndex) - this.mInitialTouchY;
