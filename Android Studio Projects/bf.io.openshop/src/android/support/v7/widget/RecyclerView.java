...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild
{
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        final boolean b2 = (this.mItemsAddedOrRemoved || this.mItemsChanged) && b;
        this.mState.mRunSimpleAnimations = (this.mFirstLayoutComplete && this.mItemAnimator != null && (this.mDataSetHasChangedAfterLayout || b2 || this.mLayout.mRequestedSimpleAnimations) && (!this.mDataSetHasChangedAfterLayout || this.mAdapter.hasStableIds()) && b);
        final State mState = this.mState;
        if (!this.mState.mRunSimpleAnimations || !b2 || this.mDataSetHasChangedAfterLayout || !this.predictiveItemAnimationsEnabled()) {
            b = false;
        }
    ...
    public View focusSearch(final View view, final int n) {
        ...
        if (view2 == null && this.mAdapter != null && this.mLayout != null && !this.isComputingLayout() && !this.mLayoutFrozen) {
            this.eatRequestLayout();
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper((AdapterHelper.Callback)new AdapterHelper.Callback() {
            ...
            public void offsetPositionsForRemovingInvisible(final int n, final int n2) {
                ...
                RecyclerView.this.mItemsAddedOrRemoved = true;
                RecyclerView.this.mState.mDeletedInvisibleItemCountSincePreviousLayout += n2;
            }
    ...
    public boolean onGenericMotionEvent(final MotionEvent motionEvent) {
        if (this.mLayout != null && !this.mLayoutFrozen && (0x2 & MotionEventCompat.getSource(motionEvent)) != 0x0 && motionEvent.getAction() == 8) {
            float n;
    ...
    public final class Recycler
    {
        ...
        void recycleViewHolderInternal(final ViewHolder viewHolder) {
            ...
            boolean b3 = false;
            Label_0278: {
                if (RecyclerView.this.mAdapter == null || !access$4900 || !RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder) || !b) {
    ...
    private class ViewFlinger implements Runnable
    {
        ...
        public void run() {
            ...
            if (mScroller.computeScrollOffset()) {
                ...
                final Adapter access$3100 = RecyclerView.this.mAdapter;
                int scrollHorizontallyBy = 0;
                int n3 = 0;
                int n4 = 0;
                int scrollVerticallyBy = 0;
