...
public class RequestCreator
{
    ...
    public void into(final Target target) {
        ...
        if (!this.data.hasImage()) {
            ...
            final boolean setPlaceholder = this.setPlaceholder;
        ...
        final boolean setPlaceholder2 = this.setPlaceholder;
    ...
    public RequestCreator memoryPolicy(final MemoryPolicy memoryPolicy, final MemoryPolicy... array) {
        ...
        if (array.length > 0) {
            for (final MemoryPolicy memoryPolicy2 : array) {
    ...
    public RequestCreator networkPolicy(final NetworkPolicy networkPolicy, final NetworkPolicy... array) {
        ...
        if (array.length > 0) {
            for (final NetworkPolicy networkPolicy2 : array) {
