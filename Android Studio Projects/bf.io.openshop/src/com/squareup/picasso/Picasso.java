...
public class Picasso
{
    ...
    public static void setSingletonInstance(final Picasso singleton) {
    ...
    void resumeAction(final Action action) {
        final boolean shouldReadFromMemoryCache = MemoryPolicy.shouldReadFromMemoryCache(action.memoryPolicy);
        Bitmap quickMemoryCacheCheck = null;
        if (shouldReadFromMemoryCache) {
