...
public final class AccessToken implements Parcelable
{
    ...
    private static AccessToken createFromBundle(final List<String> list, final Bundle bundle, final AccessTokenSource accessTokenSource, final Date date, final String s) {
        final String string = bundle.getString("access_token");
        final Date bundleLongAsDate = Utility.getBundleLongAsDate(bundle, "expires_in", date);
    ...
    @Override
    public int hashCode() {
        final int n = 31 * (31 * (31 * (31 * (31 * (31 * (527 + this.expires.hashCode()) + this.permissions.hashCode()) + this.declinedPermissions.hashCode()) + this.token.hashCode()) + this.source.hashCode()) + this.lastRefresh.hashCode());
        int hashCode;
        if (this.applicationId == null) {
            hashCode = 0;
        }
        ...
        return 31 * (n + hashCode) + this.userId.hashCode();
    }
