...
public final class Gson
{
    ...
    public <T> TypeAdapter<T> getAdapter(final TypeToken<T> typeToken) {
        ...
        boolean b = false;
        if (o == null) {
            o = new HashMap<TypeToken<T>, FutureTypeAdapter<Object>>();
            this.calls.set((Map<TypeToken<?>, FutureTypeAdapter<?>>)o);
            b = true;
        }
        final FutureTypeAdapter<?> futureTypeAdapter = ((Map<TypeToken<T>, FutureTypeAdapter<Object>>)o).get(typeToken);
        ...
        try {
            ...
            ((Map<TypeToken<T>, FutureTypeAdapter<Object>>)o).put(typeToken, futureTypeAdapter2);
            ...
            ((Map<TypeToken<T>, FutureTypeAdapter<Object>>)o).remove(typeToken);
            if (b) {
                this.calls.remove();
            }
        }
    ...
    public <T> TypeAdapter<T> getDelegateAdapter(final TypeAdapterFactory typeAdapterFactory, final TypeToken<T> typeToken) {
        final boolean contains = this.factories.contains(typeAdapterFactory);
        int n = 0;
        if (!contains) {
            n = 1;
        }
