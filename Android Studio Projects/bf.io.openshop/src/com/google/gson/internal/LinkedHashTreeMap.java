...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable
{
    ...
    private void rebalance(final Node<K, V> node, final boolean b) {
        for (Node<K, V> parent = node; parent != null; parent = parent.parent) {
            ...
            if (n == -2) {
                ...
                assert n == 1;
                parent.height = 1 + Math.max(height, height2);
                if (!b) {
                    return;
                }
            }
    ...
    private void replaceInParent(final Node<K, V> node, final Node<K, V> node2) {
        ...
        if (parent == null) {
            this.table[node.hash & -1 + this.table.length] = node2;
            return;
        }
        if (parent.left == node) {
            parent.left = node2;
    ...
    private void rotateLeft(final Node<K, V> node) {
        ...
        node.height = 1 + Math.max(height, height2);
        final int height3 = node.height;
        int height4 = 0;
        if (right2 != null) {
            height4 = right2.height;
        }
        right.height = 1 + Math.max(height3, height4);
    }
    ...
    private void rotateRight(final Node<K, V> node) {
        ...
        left.height = 1 + Math.max(height3, height4);
    }
    
    private static int secondaryHash(final int n) {
    ...
    Node<K, V> find(final K k, final boolean b) {
        ...
        final int n = secondaryHash & -1 + table.length;
        ...
        if (b) {
            ...
            if (node == null) {
                ...
                node4 = new Node<K, V>((Node<Object, Object>)node, k, secondaryHash, (Node<Object, Object>)header, (Node<Object, Object>)header.prev);
                table[n] = (Node<K, V>)node4;
            }
            else {
                node4 = new Node<K, V>(node, k, secondaryHash, header, header.prev);
                if (n2 < 0) {
                    node.left = (Node<K, V>)node4;
                }
                else {
                    node.right = (Node<K, V>)node4;
                }
    ...
    void removeInternal(final Node<K, V> node, final boolean b) {
        ...
        if (left != null && right != null) {
            ...
            node2.height = 1 + Math.max(height, height2);
