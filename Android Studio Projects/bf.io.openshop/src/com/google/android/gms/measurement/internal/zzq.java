...
{
    public zzq(final zzw zzw) {
        super(zzw);
    }
    
    @WorkerThread
    private byte[] zzc(final HttpURLConnection httpURLConnection) throws IOException {
    ...
    @WorkerThread
    public void zza(final String s, final URL url, final Map<String, String> map, final zza zza) {
        this.zzjk();
        this.zzjv();
        zzx.zzz(url);
        zzx.zzz(zza);
        this.zzCn().zzh(new zzc(s, url, null, map, zza));
    }
    
    @WorkerThread
    public void zza(final String s, final URL url, final byte[] array, final Map<String, String> map, final zza zza) {
        this.zzjk();
        this.zzjv();
        zzx.zzz(url);
        zzx.zzz(array);
        zzx.zzz(zza);
        this.zzCn().zzh(new zzc(s, url, array, map, zza));
    }
    
    @WorkerThread
    protected HttpURLConnection zzc(final URL url) throws IOException {
        ...
        httpURLConnection.setConnectTimeout((int)this.zzCp().zzBO());
        httpURLConnection.setReadTimeout((int)this.zzCp().zzBP());
    ...
    interface zza
    {
        void zza(final String p0, final int p1, final Throwable p2, final byte[] p3);
    }
