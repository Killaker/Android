...
{
    List<UserAttributeParcel> zza(final AppMetadata p0, final boolean p1) throws RemoteException;
    
    void zza(final AppMetadata p0) throws RemoteException;
    
    void zza(final EventParcel p0, final AppMetadata p1) throws RemoteException;
    
    void zza(final EventParcel p0, final String p1, final String p2) throws RemoteException;
    
    void zza(final UserAttributeParcel p0, final AppMetadata p1) throws RemoteException;
    
    void zzb(final AppMetadata p0) throws RemoteException;
