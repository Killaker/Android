...
{
    zzd newCameraPosition(final CameraPosition p0) throws RemoteException;
    
    zzd newLatLng(final LatLng p0) throws RemoteException;
    
    zzd newLatLngBounds(final LatLngBounds p0, final int p1) throws RemoteException;
    
    zzd newLatLngBoundsWithSize(final LatLngBounds p0, final int p1, final int p2, final int p3) throws RemoteException;
    
    zzd newLatLngZoom(final LatLng p0, final float p1) throws RemoteException;
    
    zzd scrollBy(final float p0, final float p1) throws RemoteException;
    
    zzd zoomBy(final float p0) throws RemoteException;
    
    zzd zoomByWithFocus(final float p0, final int p1, final int p2) throws RemoteException;
    
    zzd zoomIn() throws RemoteException;
    
    zzd zoomOut() throws RemoteException;
    
    zzd zoomTo(final float p0) throws RemoteException;
