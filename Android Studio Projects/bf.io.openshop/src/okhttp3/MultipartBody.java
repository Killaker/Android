...
public final class MultipartBody extends RequestBody
{
    ...
    private long writeOrCountBytes(BufferedSink bufferedSink, final boolean b) throws IOException {
        long n = 0L;
        ...
        for (int i = 0; i < this.parts.size(); ++i) {
            ...
            final Headers access$000 = part.headers;
            final RequestBody access$2 = part.body;
            bufferedSink.write(MultipartBody.DASHDASH);
            bufferedSink.write(this.boundary);
            bufferedSink.write(MultipartBody.CRLF);
            if (access$000 != null) {
                for (int j = 0; j < access$000.size(); ++j) {
                    bufferedSink.writeUtf8(access$000.name(j)).write(MultipartBody.COLONSPACE).writeUtf8(access$000.value(j)).write(MultipartBody.CRLF);
                }
            }
